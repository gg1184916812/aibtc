...
def init_database():
    ...
    try:
        ...
        # 允许环境变量覆盖数据库路径
        db_path = os.getenv('DB_NAME', db_path)
...
def create_app():
    ...
    # ====== NEW: AI 智慧预测 ======
    from .routes.api_ai_predictor import api_ai_predictor
    from .routes.api_data import api_data   
    ...
    app.register_blueprint(api_ai_predictor)  # <--- NEW
    ...
    def data_download_page():
        return render_template('data_download.html', active_page='data_download')
    ...
    def ai_predictor_page():
        return render_template('ai_predictor.html', active_page='ai_predictor')
