                    ...
                    y: {
                        ...
                        ticks: {
                            callback: function(value) {
                                if (value === 70) return '70 (超買)';
                                if (value === 30) return '30 (超賣)';
                                return value;
                            }
                        }
                    },
...
function updatePriceChart(symbol = 'XAUUSDm') {
...
function updateRsiChart(symbol = 'XAUUSDm') {
    if (typeof Chart === 'undefined') return;
